...
@section('title','Data-Info Tafsir')
@section('content')
...
<div class="content-wrapper">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('data-info-tafsir.destroy', 'delete') }}" method="POST" id="myform" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                ...
                <br>
                @if($filter_status == 0)
                <form class="form-inline" action="{{ route('masternfoInterpretation.filter') }}" method="get">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <input name="search" class="form-control" placeholder="Pencarian Nama">
                        </select>
                    </div>&nbsp;&nbsp;
                    <div class="form-group">
                ...
                <form class="form-inline" action="{{ route('masternfoInterpretation.filter') }}" method="get">
                    ...
                    <div class="form-group">
                    <input name="search" class="form-control" value="{{$search}}" placeholder="Pencarian Nama">
                    </div>&nbsp;&nbsp;
                    <div class="form-group">
                        <button class="btn btn-success form-control" type="submit">Search</button>
                    </div>
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('data-info-tafsir.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off" id="userform">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="name" maxlength="100" class="form-control" placeholder="Masukkan Nama (Maks 100 Karakter)" required>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="edit-data">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" name="name" id="name" maxlength="100" class="form-control" placeholder="Masukkan Nama (Maks 100 Karakter)" required>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary">Save</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#editModal').on('show.bs.modal', function(e) {
            ...
            var r = "{{ route('data-info-tafsir.index') }}";
            var route = r + "/" + rowid;
            $.ajax({
                type: 'GET',
                url: "{{ route('data-info-tafsir.index') }}/" + rowid + "/edit",
                data: 'rowid=' + rowid,
